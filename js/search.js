document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleSearch = () => {
        ...
        // Tampilkan hasil pencarian hanya jika panjang query lebih dari 3 karakter
        if (query.length < 3) {
            resultsContainer.style.display = 'none'; // Sembunyikan hasil jika kurang dari 3 karakter
            return;
        }
    ...
    // Fungsi untuk pencarian ketika "Enter" ditekan atau ikon diklik
    const handleInstantSearch = () => {
        const query = searchInput.value.toLowerCase();

        // Pastikan input tidak kosong dan panjangnya lebih dari 4 karakter
